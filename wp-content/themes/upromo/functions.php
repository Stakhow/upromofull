...
if ( ! function_exists( 'upromo_setup' ) ) :
  ...
  function upromo_setup() {
    ...
    register_nav_menus( array(
      ...
      'menu-2' => esc_html__( 'InSidebar', 'upromo' ),
    ) );
...
//<!--  </div>-->
      ...
      elseif( $mark === 'schema.org' ) $mark = array(
        ...
        'linkpatt'   => '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a href="%s" itemprop="item"><li itemprop="name">%s</li></a></li>',
        'sep_after'  => '',
      );
